...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.intro'
        db.delete_column(u'fluent_blogs_entry', 'intro')

        # Deleting field 'Entry.title'
        db.delete_column(u'fluent_blogs_entry', 'title')

        # Deleting field 'Entry.slug'
        db.delete_column(u'fluent_blogs_entry', 'slug')


    def backwards(self, orm):
        # Adding field 'Entry.intro'
        db.add_column(u'fluent_blogs_entry', 'intro',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Entry.title'
        db.add_column(u'fluent_blogs_entry', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Entry.slug'
        db.add_column(u'fluent_blogs_entry', 'slug',
