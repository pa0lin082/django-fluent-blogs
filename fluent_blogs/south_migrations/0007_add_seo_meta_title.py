...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry_Translation.meta_title'
        db.add_column(u'fluent_blogs_entry_translation', 'meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry_Translation.meta_title'
        db.delete_column(u'fluent_blogs_entry_translation', 'meta_title')
