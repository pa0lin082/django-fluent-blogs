...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute(
            'INSERT INTO fluent_blogs_entry_translation(title, slug, intro, language_code, master_id)'
            ' SELECT title, slug, intro, %s, id FROM fluent_blogs_entry',
    ...
    def backwards(self, orm):
        ...
        for entry in orm['fluent_blogs.Entry'].objects.all():
            ...
            entry.save()   # As intended: doesn't call Entry.save() but Model.save() only.
