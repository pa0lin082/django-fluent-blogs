...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry_Translation.meta_keywords'
        db.add_column(u'fluent_blogs_entry_translation', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Entry_Translation.meta_description'
        db.add_column(u'fluent_blogs_entry_translation', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry_Translation.meta_keywords'
        db.delete_column(u'fluent_blogs_entry_translation', 'meta_keywords')

        # Deleting field 'Entry_Translation.meta_description'
        db.delete_column(u'fluent_blogs_entry_translation', 'meta_description')
    ...
    models = {
        ...
        'fluent_blogs.entry': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['categories.Category']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'fluent_blogs.entry_translation': {
            'Meta': {'object_name': 'Entry_Translation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro': ('django.db.models.fields.TextField', [], {}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['fluent_blogs.Entry']"}),
